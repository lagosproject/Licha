...
def generate_mock_screenshot(screen_type, lang, width, height):
    """
    ...
    if screen_type == "login":
        ...
        lbl_status = "Connected to #twitch_streamer" if lang == "en-US" else "Conectado a #twitch_streamer" if lang == "es-ES" else "Connecté à #twitch_streamer"
...
def get_raw_screenshot(screen_type, lang, width, height, form_factor):
    """
    ...
    mock_img = generate_mock_screenshot(screen_type, lang, width, height)
...
def make_showcase_card(screen_type, lang, form_factor, out_path):
    ...
    raw_img = get_raw_screenshot(screen_type, lang, raw_w, raw_h, form_factor).convert("RGBA")
